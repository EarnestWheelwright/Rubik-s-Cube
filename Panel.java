...
public class Panel extends JPanel {
	...
	// x,y are coordinates of where the top left corner of a square if the hexigon
	// fit perfectly within the square.
	...
	// coords is a 2d array containing one array of x coordinates, and one array of
	// y coordinates
	...
	// Returns a set of coordinates objects of a 6 sided shape of divider lines for
	// the cube
	...
	// Returns a set of coordinate objects in the shape of a shape, a mirror result
	// of lineCoordsTop;
